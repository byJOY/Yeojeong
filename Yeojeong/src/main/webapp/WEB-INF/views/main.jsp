...
<html>
    ...
    <!-- Bootstrap core CSS -->
    <link href="res/bootstrap/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="about.html">여정등록</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="services.html">여정관리</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="contact.html">여행메이트관리</a>
            </li>
